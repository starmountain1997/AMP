...
def modelers2openi(model_id, openi_repo_id="starmountain1997/AMP",if_hf:bool=True):
...
def reupload2modelers(model_name: str, owner: str = "zhipuai"):
...
if __name__ == "__main__":
    reupload2modelers("THUDM/codegeex2-6b")
    # modelers2openi("thu-coai/CharacterGLM-6B")
    # modelers2openi("zhipuai/glm-4-9b-chat-1m",if_hf=False)
